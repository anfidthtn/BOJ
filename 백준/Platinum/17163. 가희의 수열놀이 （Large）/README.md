# [Platinum IV] 가희의 수열놀이 (Large) - 17163 

[문제 링크](https://www.acmicpc.net/problem/17163) 

### 성능 요약

메모리: 373800 KB, 시간: 1380 ms

### 분류

자료 구조(data_structures), 우선순위 큐(priority_queue), 세그먼트 트리(segtree), 스택(stack)
...
### 입력 
 ...
 <p>첫 번째 줄에는 쿼리의 수를 의미하는 정수 <em>Q</em>와 나누는 정수 <em>mod</em> 가 공백으로 구분되어 주어집니다. (1 ≤ <em>Q</em> ≤ 10<sup>6</sup>, 1 ≤ <em>mod</em> ≤ 2×10<sup>9</sup>)</p>
